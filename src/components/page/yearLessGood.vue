    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 年度最差商品
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
         <!-- <el-row>
             <el-col>
                    <el-input v-model="price"> 请输入N</el-input>
             </el-col>
            ...
            <!-- @row-click="showInfo" -->
               ...
               <el-table-column prop="minofamount" label="退订单次数"  align="center"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getData() {
            let that=this;
          this.$axios.get('http://192.168.1.104:7000/hive/list7')
            .then(function(response){
                console.log(response)

                that.tableData=response.data;
                that.tableData.forEach(Element=>{
                    Element.minofamount=Math.abs(Element.minofamount)
                })
                that.loading=false;
            }) 
